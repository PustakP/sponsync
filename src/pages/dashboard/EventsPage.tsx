        ...
        <Card className="bg-gray-800 border border-gray-700">
          <div className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <input
              ...
              className="px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-white"
            ...
            <Card key={event.id} className="overflow-hidden bg-gray-800 border border-gray-700">
              ...
              <div className="p-4 space-y-4">
                <div>
                  ...
                  <p className="text-xl font-semibold text-gray-950">{event.college}</p>
                </div>
